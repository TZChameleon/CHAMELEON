...
enum teecore_memtypes {
	...
	MEM_AREA_TEE_RAM_RX_LIB1,
	MEM_AREA_TEE_RAM_RX_LIB2,
	MEM_AREA_TEE_RAM_RX_LIB3,
	MEM_AREA_TEE_RAM_RX_LIB4,
	MEM_AREA_TEE_RAM_RX_LIB5,
	MEM_AREA_TEE_RAM_RX_LIB6,
	MEM_AREA_TEE_RAM_RX_LIB7,
	MEM_AREA_TEE_RAM_RX_LIB8,
	MEM_AREA_TEE_RAM_RX_LIB9,
	MEM_AREA_TEE_RAM_RX_LIB10,
	MEM_AREA_TEE_RAM_RX_OTHERS,
#endif
	MEM_AREA_TEE_RAM_RO,
	MEM_AREA_TEE_RAM_RW,
...
#ifdef CFG_SERVICE_SLICE
		[MEM_AREA_TEE_RAM_RX_LIB1] = "TEE_RAM_RX_LIB1",
		[MEM_AREA_TEE_RAM_RX_LIB2] = "TEE_RAM_RX_LIB2",
		[MEM_AREA_TEE_RAM_RX_LIB3] = "TEE_RAM_RX_LIB3",
		[MEM_AREA_TEE_RAM_RX_LIB4] = "TEE_RAM_RX_LIB4",
		[MEM_AREA_TEE_RAM_RX_LIB5] = "TEE_RAM_RX_LIB5",
		[MEM_AREA_TEE_RAM_RX_LIB6] = "TEE_RAM_RX_LIB6",
		[MEM_AREA_TEE_RAM_RX_LIB7] = "TEE_RAM_RX_LIB7",
		[MEM_AREA_TEE_RAM_RX_LIB8] = "TEE_RAM_RX_LIB8",
		[MEM_AREA_TEE_RAM_RX_LIB9] = "TEE_RAM_RX_LIB9",
		[MEM_AREA_TEE_RAM_RX_LIB10] = "TEE_RAM_RX_LIB10",
		[MEM_AREA_TEE_RAM_RX_OTHERS] = "TEE_RAM_RX_OTHERS",
#endif
...
#ifdef CFG_SERVICE_SLICE
void slice_core_mmu_unmap_pages(vaddr_t vstart, size_t num_pages, int entry_idx);
#endif

...
extern volatile const unsigned long SecureStackBase;
extern volatile unsigned long normal_stack[1];
extern volatile unsigned long normal_ttbr[1];
extern volatile unsigned long ptr_base_tables[1];
extern volatile uint64_t slice_arguments[8];

/* spinlock for global vars */
unsigned volatile int slice_stack_spinlock;

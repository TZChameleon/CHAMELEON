...
def get_pager_bin(elffile):
    ...
    if tee_pager_bin is None:
        ...
        dump_names = re.compile(r'^\.(text|nex_data|rodata|ctors|got|data|'
                                ...
                                r'lib1_section|lib2_section|lib3_section|'
                                r'lib4_section|lib5_section|lib6_section|'
                                r'lib7_section|lib8_section|lib9_section|'
                                r'lib10_section|others_section)$')
